...
#
# Saphir | Bot Discord français pour le serveur EntreKheys
#
...
description = "Saphir - Bot modulaire français pour Discord"
...
def interactive_setup(settings):
    ...
    if first_run:
        print("Saphir - Configuration d'origine\n")
